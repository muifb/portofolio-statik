...
const { toString: ht } = Object.prototype,
  ...
  { iterator: re, toStringTag: Je } = Symbol,
  se = ((e) => (t) => {
    const n = ht.call(t);
    return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
  })(Object.create(null)),
  P = (e) => ((e = e.toLowerCase()), (t) => se(t) === e),
  oe = (e) => (t) => typeof t === e,
  { isArray: M } = Array,
  I = oe("undefined");
function V(e) {
...
const D =
  ...
  ve = (e) => !I(e) && e !== D;
function pe() {
  const { caseless: e, skipUndefined: t } = (ve(this) && this) || {},
    n = {},
    r = (s, i) => {
      const o = (e && Ke(n, i)) || i;
      Y(n[o]) && Y(s)
...
function ie(e, t, n) {
  ...
  function l(u, m, p) {
    ...
    if (u && !p && typeof u == "object") {
      if (a.endsWith(m, "{}"))
        ...
        (a.isArray(u) && en(u)) ||
        ((a.isFileList(u) || a.endsWith(m, "[]")) && (E = a.toArray(u)))
      )
        return (
          (m = Ye(m)),
  ...
  function R(u, m) {
    if (!a.isUndefined(u)) {
      ...
      h.push(u),
        a.forEach(u, function (E, x) {
          (!(a.isUndefined(E) || E === null) &&
            s.call(t, E, a.isString(x) ? x.trim() : x, m, b)) === !0 &&
            R(E, m ? m.concat(x) : [x]);
        }),
        h.pop();
    }
...
function tt(e, t, n) {
  ...
  if (
    (s
      ? (i = s(t, n))
      : (i = a.isURLSearchParams(t) ? t.toString() : new Ee(t, n).toString(r)),
    i)
  ) {
    const o = e.indexOf("#");
    o !== -1 && (e = e.slice(0, o)),
...
const at = (e) => {
      ...
      return new Promise(function (n, r) {
        ...
        "onloadend" in p
          ...
          d &&
            ...
            p.upload.addEventListener("loadend", R)),
          (s.cancelToken || s.signal) &&
            ((l = (g) => {
              p &&
                (r(!g || g.type ? new $(null, e, p) : g),
                p.abort(),
                (p = null));
            }),
    ...
    if (t || n) {
      ...
      const i = function (f) {
        if (!s) {
          ...
          r.abort(
            l instanceof y ? l : new $(l instanceof Error ? l.message : l)
          );
        }
      };
      let o =
  ...
  De = 64 * 1024,
  { isFunction: Z } = a,
  Bn = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
    a.global
  ),
  { ReadableStream: je, TextEncoder: qe } = a.global,
  He = (e, ...t) => {
    try {
      return !!e(...t);
    } catch {
  ...
  Dn = (e) => {
    e = a.merge.call({ skipUndefined: !0 }, Bn, e);
    ...
    return async (u) => {
      ...
      let G = Ln([x, g && g.toAbortSignal()], O),
        z = null;
      const B =
        G &&
        G.unsubscribe &&
      ...
      try {
        ...
        if (l && (N || (Ae && B))) {
          ...
          const H = a.toFiniteNumber(_.headers.get("content-length")),
            [le, Q] = (N && _e(H, ne(Ue(N), !0))) || [];
          _ = new r(
            Be(_.body, De, le, () => {
              Q && Q(), B && B();
            }),
        ...
        throw (
          ...
          F && F.name === "TypeError" && /Load failed|fetch/i.test(F.message)
            ? Object.assign(new y("Network Error", y.ERR_NETWORK, u, z), {
                cause: F.cause || F,
              })
  ...
  ct = (e) => {
    ...
    for (; c--; )
      (d = i[c]),
        (f = l.get(d)),
        f === void 0 && l.set(d, (f = c ? new Map() : Dn(t))),
        (l = f);
    return f;
  };
ct();
  ...
  lt = {
    getAdapter: (e, t) => {
      ...
      for (let o = 0; o < n; o++) {
        ...
        if (
          ((s = r),
          !qn(r) && ((s = ye[(c = String(r)).toLowerCase()]), s === void 0))
        )
...
const te = { assertOptions: Hn, validators: ae },
  L = te.validators;
let j = class {
  constructor(t) {
    (this.defaults = t || {}),
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (s === "dark") e.classList.add("dark");
  if (t) {
